...
class Fees
{
     ...
     *
     * @param  string  $id
     * @return Operations\ListTransferFeesResponse
     * @throws \Dwolla\Models\Errors\APIException
     */
    public function list(string $id, ?Options $options = null): Operations\ListTransferFeesResponse
    {
        $request = new Operations\ListTransferFeesRequest(
            id: $id,
        );
        $baseUrl = $this->sdkConfiguration->getTemplatedServerUrl();
        $url = Utils\Utils::generateUrl($baseUrl, '/transfers/{id}/fees', Operations\ListTransferFeesRequest::class, $request);
        $urlOverride = null;
        $httpOptions = ['http_errors' => false];
        $httpOptions['headers']['Accept'] = 'application/vnd.dwolla.v1.hal+json';
        $httpOptions['headers']['user-agent'] = $this->sdkConfiguration->userAgent;
        $httpRequest = new \GuzzleHttp\Psr7\Request('GET', $url);
        $hookContext = new HookContext($this->sdkConfiguration, $baseUrl, 'listTransferFees', [], $this->sdkConfiguration->securitySource);
        ...
        if (Utils\Utils::matchStatusCodes($statusCode, ['200'])) {
            if (Utils\Utils::matchContentType($contentType, 'application/vnd.dwolla.v1.hal+json')) {
                ...
                $obj = $serializer->deserialize($responseData, '\Dwolla\Models\Operations\ListTransferFeesResponseBody', 'json', DeserializationContext::create()->setRequireAllRequiredProperties(true));
                $response = new Operations\ListTransferFeesResponse(

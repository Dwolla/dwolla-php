...
class BusinessClassifications
{
    ...
    #[\Speakeasy\Serializer\Annotation\SkipWhenNull]
    public ?BusinessClassificationsEmbedded $embedded = null;
     ...
     * @phpstan-pure
     */
    public function __construct(?array $links = null, ?BusinessClassificationsEmbedded $embedded = null, ?int $total = null)
    {
        $this->links = $links;

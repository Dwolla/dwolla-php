...
class RetryVerifiedBusinessWithInternationalController
{
    /**
     *
    ...
    /**
     *
     * @var RetryVerifiedBusinessWithInternationalControllerController $controller
     */
    #[\Speakeasy\Serializer\Annotation\SerializedName('controller')]
    #[\Speakeasy\Serializer\Annotation\Type('\Dwolla\Models\Components\RetryVerifiedBusinessWithInternationalControllerController')]
    public RetryVerifiedBusinessWithInternationalControllerController $controller;
     ...
     * @param  RetryVerifiedBusinessWithInternationalControllerController  $controller
     ...
     * @phpstan-pure
     */
    public function __construct(string $firstName, string $lastName, string $email, string $type, string $address1, string $city, string $state, string $postalCode, RetryVerifiedBusinessWithInternationalControllerController $controller, string $businessClassification, string $businessType, string $businessName, string $ein, ?string $ipAddress = null)
    {

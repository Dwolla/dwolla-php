...
/** CreateVerifiedBusinessCustomerWithController - Create a Verified Business customer with a US controller */
class CreateVerifiedBusinessCustomerWithController
{
    /**
     *
    ...
    public CreateVerifiedBusinessCustomerWithControllerController $controller;
    ...
    public CreateVerifiedBusinessCustomerWithControllerBusinessType $businessType;
     ...
     * @phpstan-pure
     */
    public function __construct(string $firstName, string $lastName, string $email, string $address1, string $city, string $state, string $postalCode, string $businessClassification, string $businessName, string $ein, CreateVerifiedBusinessCustomerWithControllerController $controller, CreateVerifiedBusinessCustomerWithControllerBusinessType $businessType, ?string $ipAddress = null, ?string $phone = null, ?string $correlationId = null, ?string $address2 = null, ?string $doingBusinessAs = null, ?string $website = null, string $type = 'business')
    {

...
/** CreateVerifiedSolePropCustomer - Create a Verified Business customer (Sole Proprietorship) */
class CreateVerifiedSolePropCustomer
{
    /**
     *
     ...
     * @phpstan-pure
     */
    public function __construct(string $firstName, string $lastName, string $email, string $address1, string $city, string $state, string $postalCode, string $ssn, string $dateOfBirth, string $businessClassification, string $businessName, ?string $ipAddress = null, ?string $phone = null, ?string $correlationId = null, ?string $address2 = null, ?string $doingBusinessAs = null, ?string $ein = null, ?string $website = null, string $type = 'business', string $businessType = 'soleProprietorship')
    {

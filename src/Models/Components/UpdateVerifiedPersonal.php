...
class UpdateVerifiedPersonal
{
     ...
     * @phpstan-pure
     */
    public function __construct(?string $email = null, ?string $ipAddress = null, ?string $address1 = null, ?string $address2 = null, ?string $city = null, ?string $state = null, ?string $postalCode = null, ?string $phone = null)
    {
        $this->email = $email;

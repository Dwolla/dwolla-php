...
class RetryVerifiedBusinessWithInternationalControllerAddress
{
    /**
     *
     * @var string $address1
     ...
     * @phpstan-pure
     */
    public function __construct(string $address1, string $city, string $country, string $stateProvinceRegion, ?string $address2 = null, ?string $address3 = null, ?string $postalCode = null)
    {

...
class RetryVerifiedBusinessNoController
{
    /**
     *
     ...
     * @phpstan-pure
     */
    public function __construct(string $firstName, string $lastName, string $email, string $type, string $address1, string $city, string $state, string $postalCode, string $businessClassification, string $businessType, string $businessName, string $ein, ?string $ipAddress = null)
    {

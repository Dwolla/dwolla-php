...
/** ReceiveOnlyCustomer - Receive-only user - can only receive funds, not send */
class ReceiveOnlyCustomer
{
    /**
     * $links
     *
    ...
    public ReceiveOnlyCustomerType $type;
    ...
    public ReceiveOnlyCustomerStatus $status;
     ...
     * @phpstan-pure
     */
    public function __construct(array $links, string $id, string $firstName, string $lastName, string $email, \DateTime $created, ReceiveOnlyCustomerType $type, ReceiveOnlyCustomerStatus $status, ?string $correlationId = null, ?string $businessName = null)
    {
        $this->links = $links;
        $this->id = $id;

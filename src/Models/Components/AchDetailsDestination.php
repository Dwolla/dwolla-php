...
/** AchDetailsDestination - Information sent to the destination/receiving bank account along with the transfer */
class AchDetailsDestination
{
    /**
    ...
    public ?DestinationAddenda $addenda = null;
    ...
    #[\Speakeasy\Serializer\Annotation\SkipWhenNull]
    public ?DestinationCompanyEntryDescription $companyEntryDescription = null;
     ...
     * @phpstan-pure
     */
    public function __construct(?DestinationAddenda $addenda = null, ?string $beneficiaryName = null, ?DestinationCompanyEntryDescription $companyEntryDescription = null, ?string $companyId = null, ?string $companyName = null, ?LocalDate $effectiveDate = null, ?string $postingData = null, ?string $routingNumber = null, ?string $traceId = null)
    {

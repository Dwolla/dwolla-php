...
class RetryVerifiedBusinessWithController
{
    /**
     *
    ...
    /**
     *
     * @var RetryVerifiedBusinessWithControllerController $controller
     */
    #[\Speakeasy\Serializer\Annotation\SerializedName('controller')]
    #[\Speakeasy\Serializer\Annotation\Type('\Dwolla\Models\Components\RetryVerifiedBusinessWithControllerController')]
    public RetryVerifiedBusinessWithControllerController $controller;
     ...
     * @param  RetryVerifiedBusinessWithControllerController  $controller
     ...
     * @phpstan-pure
     */
    public function __construct(string $firstName, string $lastName, string $email, string $type, string $address1, string $city, string $state, string $postalCode, RetryVerifiedBusinessWithControllerController $controller, string $businessClassification, string $businessType, string $businessName, string $ein, ?string $ipAddress = null)
    {

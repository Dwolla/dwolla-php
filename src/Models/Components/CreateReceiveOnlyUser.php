...
/** CreateReceiveOnlyUser - Create a Receive Only User */
class CreateReceiveOnlyUser
{
    /**
     *
     ...
     * @phpstan-pure
     */
    public function __construct(string $firstName, string $lastName, string $email, ?string $ipAddress = null, ?string $phone = null, ?string $correlationId = null, ?string $businessName = null, string $type = 'receive-only')
    {

...
class CustomersKba
{
     ...
     *
     * @param  string  $id
     * @return Operations\InitiateKbaForCustomerResponse
     * @throws \Dwolla\Models\Errors\APIException
     */
    public function initiate(string $id, ?Options $options = null): Operations\InitiateKbaForCustomerResponse
    {
        $request = new Operations\InitiateKbaForCustomerRequest(
            id: $id,
        );
        $baseUrl = $this->sdkConfiguration->getTemplatedServerUrl();
        $url = Utils\Utils::generateUrl($baseUrl, '/customers/{id}/kba', Operations\InitiateKbaForCustomerRequest::class, $request);
        $urlOverride = null;
        $httpOptions = ['http_errors' => false];
        $httpOptions['headers']['Accept'] = 'application/vnd.dwolla.v1.hal+json';
        $httpOptions['headers']['user-agent'] = $this->sdkConfiguration->userAgent;
        $httpRequest = new \GuzzleHttp\Psr7\Request('POST', $url);
        $hookContext = new HookContext($this->sdkConfiguration, $baseUrl, 'initiateKbaForCustomer', [], $this->sdkConfiguration->securitySource);
        ...
        if (Utils\Utils::matchStatusCodes($statusCode, ['201'])) {
            ...
            return new Operations\InitiateKbaForCustomerResponse(
            ...
            if (Utils\Utils::matchContentType($contentType, 'application/vnd.dwolla.v1.hal+json')) {
                ...
                $obj = $serializer->deserialize($responseData, '\Dwolla\Models\Errors\InvalidResourceStateSchemaException|\Dwolla\Models\Errors\ForbiddenError', 'json', DeserializationContext::create()->setRequireAllRequiredProperties(true));
